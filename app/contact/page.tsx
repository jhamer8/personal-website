...
function Contact() {
  return (
    <div className="flex flex-1 justify-center h-screen w-full z-50 overflow-auto dark:bg-gray-900">
      <div className="flex flex-1 flex-row justify-around mt-12">
        <div className="hidden sm:flex flex-col text-white">
          ...
          <p className="text-2xl font-bold">Want to reach out to me?</p>
          <p className="text-2xl font-bold">Please fill out this form here!</p>
          <div className="mt-8">
